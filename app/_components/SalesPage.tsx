...
export function SalesPage({ hero }: { hero: HeroContent }) {
  return <main>
    ...
    <section className="hero" id="inicio"><div className="hero-glow" /><div className="container hero-grid">
      <div className="hero-copy"><p className="eyebrow"><i /> {hero.eyebrow}</p><h1>{hero.title} <em>{hero.highlight}</em></h1><p className="hero-lead">{hero.support}</p><CTA>{hero.cta}</CTA><div className="micro-proof"><span>21 perguntas</span><i /><span>Diagnóstico D7E</span><i /><span>Primeiro passo em 7 dias</span></div></div>
      <figure className="hero-visual"><div className="visual-frame"><img src="/jabez-headline.png" alt="Jabez de Castro, criador do Método 7E" width="1086" height="1448" /></div><figcaption><span>Antes de tratar,</span><strong>faça o Raio-X.</strong></figcaption></figure>
    </div></section>
